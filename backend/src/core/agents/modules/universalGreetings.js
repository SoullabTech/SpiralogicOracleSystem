...
exports.default = exports.CONSCIOUSNESS_GREETINGS = exports.MODE_GREETING_STYLES = exports.UNIVERSAL_GREETINGS = void 0;
exports.selectGreeting = selectGreeting;
exports.getGreetingByIntent = getGreetingByIntent;
// ===============================================
// UNIVERSAL CONSCIOUSNESS GREETINGS
// For every soul ready to live consciously
// ===============================================
exports.UNIVERSAL_GREETINGS = [
    {
        id: 'heart-check',
...
// ===============================================
exports.CONSCIOUSNESS_GREETINGS = {
    awakening: [
...
// ===============================================
function selectGreeting(mode, userContext, timeOfDay, consciousness) {
    // Select based on consciousness level if provided
    if (consciousness && exports.CONSCIOUSNESS_GREETINGS[consciousness]) {
        const greetings = exports.CONSCIOUSNESS_GREETINGS[consciousness];
    ...
    if (mode && exports.MODE_GREETING_STYLES[mode]) {
        const modeStyle = exports.MODE_GREETING_STYLES[mode];
    ...
    return exports.UNIVERSAL_GREETINGS[Math.floor(Math.random() * exports.UNIVERSAL_GREETINGS.length)];
}
function getGreetingByIntent(intent) {
    return exports.UNIVERSAL_GREETINGS.find(greeting => greeting.id === intent ||
        greeting.question.toLowerCase().includes(intent.toLowerCase())) || null;
}
