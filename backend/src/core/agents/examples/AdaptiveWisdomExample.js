...
export class ExampleOracle {
    ...
    buildUserContext(input, history) {
    ...
    generateJungResponse(input, routing) {
    ...
    generateBuddhaResponse(input, routing) {
    ...
    generateHybridResponse(input, routing) {
