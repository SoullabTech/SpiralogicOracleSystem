...
router.post('/daily-checkin', async (req, res) => {
    try {
        ...
        const guidance = await retreatSupportService.generateDailyGuidance(validation.data.participantId, validation.data);
        // Update group dynamics
        await groupDynamicsService.updateParticipantState(validation.data.retreatId, validation.data.participantId, validation.data);
        res.json({
            success: true,
            checkIn,
            guidance,
...
router.post('/session/:sessionId/participation', async (req, res) => {
    try {
        ...
        await groupDynamicsService.updateSessionDynamics(validation.data.sessionId, validation.data);
        res.json({
            success: true,
            participation,
...
router.post('/wisdom/capture', async (req, res) => {
    try {
        ...
        await retreatSupportService.broadcastWisdom(validation.data.retreatId, wisdom);
        res.json({
            success: true,
            wisdom,
...
router.get('/insights/:participantId', async (req, res) => {
    try {
        ...
        const insights = await retreatSupportService.getParticipantInsights(participantId, retreatId);
        res.json({
            participantId,
            insights,
