...
async function saveJournalEntry(entry) {
    ...
    if (error) {
        ...
        throw (0, errorHandler_1.createError)('Failed to save journal entry', 500);
    }
    return data;
}
...
async function getSymbolThreads(userId) {
    ...
    if (error) {
        ...
        throw (0, errorHandler_1.createError)('Failed to fetch memory threads', 500);
    }
    return data;
}
async function semanticSearch(userId, query) {
    ...
    if (error) {
        ...
        throw (0, errorHandler_1.createError)('Semantic search failed', 500);
    }
    return data;
}
