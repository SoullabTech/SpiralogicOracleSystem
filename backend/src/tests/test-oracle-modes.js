...
const oracleModes = ['alchemist', 'buddha', 'sage', 'mystic', 'guardian'];
...
function detectThemeType(input) {
...
function getThemeResponseForMode(theme, mode) {
...
function formatResponse(response, color) {
