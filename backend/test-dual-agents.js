...
async function runTests() {
  ...
  const fireResponse = await fireAgent.getOracleResponse(
  ...
  const waterResponse = await waterAgent.getOracleResponse(
  ...
  const result = await agentOrchestrator.routeToAgent(
    "I have a vision but feel scared",
  );
