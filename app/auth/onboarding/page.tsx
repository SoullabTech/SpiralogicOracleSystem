...
export default function OnboardingPage() {
  ...
  const renderStepContent = () => {
    switch (onboardingSteps[currentStep].id) {
      ...
      case "development_assessment":
        return (
          <DevelopmentAssessmentStep
            ...
            onChange={(data) =>
              updateOnboardingData("developmentAssessment", data)
            }
            onNext={nextStep}
            onPrev={prevStep}
          />
      ...
      case "integration_commitment":
        return (
          <IntegrationCommitmentStep
            ...
            onChange={(data) =>
              updateOnboardingData("integrationCommitment", data)
            }
            onNext={nextStep}
            onPrev={prevStep}
          />
      ...
      case "completion":
        return (
          <CompletionStep onComplete={completeOnboarding} onPrev={prevStep} />
        );
  ...
  <div className="space-y-6">
    <div className="prose max-w-none">
      ...
      <div className="space-y-4 text-gray-700">
        <p>
          This platform is designed to support your human development through a
          process that honors the slow, spiral nature of growth. We emphasize
          integration over accumulation, ordinary moments over peak experiences,
          and community reality-checking over individual insight collection.
        </p>
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            <strong>Process over breakthrough:</strong> We celebrate consistent
            daily practice over dramatic revelations
          </li>
          <li>
            <strong>Integration requirements:</strong> New content is gated
            behind demonstrated real-world application
          </li>
          <li>
            <strong>Reality grounding:</strong> Built-in prompts prevent
            spiritual bypassing and magical thinking
          </li>
          <li>
            <strong>Community support:</strong> Peer validation for authentic
            development, not spiritual performance
          </li>
          <li>
            <strong>Professional integration:</strong> Seamless connection with
            therapists and coaches when needed
          </li>
        </ul>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <p className="text-blue-800 text-sm">
            This platform serves as a tool for reflection and practice, not as a
            source of spiritual authority. Your own discernment, lived
            experience, and professional support when needed are always the
    ...
    <div className="grid grid-cols-1 gap-6">
      <div>
        ...
        <p className="text-xs text-gray-500 mt-1">
          This will be visible to other community members based on your privacy
          settings.
        </p>
      </div>
      ...
      <div>
        ...
        />
        <p className="text-xs text-gray-500 mt-1">
          This helps us connect you with appropriate resources and
          opportunities.
        </p>
      </div>
    </div>
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-600 mb-4">
          What areas of life are you currently navigating? (Select all that
          apply)
        </p>
          ...
          {challengeOptions.map((challenge) => (
            ...
            >
              <input
                ...
                onChange={() =>
                  toggleArrayItem(data.currentChallenges, challenge, (items) =>
                    onChange({ currentChallenges: items }),
                  )
                }
          ...
          {supportOptions.map((support) => (
            ...
            >
              <input
                ...
                onChange={() =>
                  toggleArrayItem(data.supportSought, support, (items) =>
                    onChange({ supportSought: items }),
                  )
                }
                className="text-blue-600 focus:ring-blue-500"
              />
      ...
      <div>
        ...
        <div className="space-y-3">
          {[
            {
              value: "beginner",
              label: "New to personal development work",
              description: "Just starting to explore growth practices",
            },
            {
              value: "intermediate",
              label: "Some experience with development practices",
              description: "Familiar with basic concepts and practices",
            },
            {
              value: "advanced",
              label: "Experienced in personal development",
              description: "Well-versed in various approaches and methods",
            },
          ].map((option) => (
            <label
              key={option.value}
      ...
      <div>
        ...
        <label className="flex items-start space-x-3 cursor-pointer">
          <input
            ...
            onChange={(e) =>
              onChange({ professionalSupportHistory: e.target.checked })
            }
            className="mt-1 text-blue-600 focus:ring-blue-500"
          />
          <div>
            <div className="text-sm font-medium text-gray-900">
              I have experience working with therapists, coaches, or spiritual
              directors
            </div>
            <div className="text-xs text-gray-600">
              This helps us understand your familiarity with professional
              support
            </div>
          </div>
        </label>
      ...
      <div className="space-y-3">
        {[
          ...
          },
          {
            ...
            description:
              "Share with others focused on mutual support and growth",
          },
          {
            value: "open",
          ...
          >
            <input
              ...
              onChange={(e) =>
                onChange({ communityVisibility: e.target.value as any })
              }
              className="mt-1 text-blue-600 focus:ring-blue-500"
            />
            <div>
    ...
    <div>
      ...
      <label className="flex items-start space-x-3 cursor-pointer">
        <input
          ...
          onChange={(e) =>
            onChange({ professionalSupportConsent: e.target.checked })
          }
          className="mt-1 text-blue-600 focus:ring-blue-500"
        />
        <div>
          ...
          <div className="text-xs text-gray-600">
            Enable referrals to therapists, coaches, or other professionals when
            patterns suggest benefit
          </div>
        </div>
      </label>
    </div>
    ...
    <div>
      ...
      <label className="flex items-start space-x-3 cursor-pointer">
        <input
          ...
          onChange={(e) =>
            onChange({ researchParticipation: e.target.checked })
          }
          className="mt-1 text-blue-600 focus:ring-blue-500"
        />
        <div>
          ...
          <div className="text-xs text-gray-600">
            Help improve integration-centered approaches through anonymous
            research data
          </div>
        </div>
      </label>
  ...
  const commitments = [
    {
      ...
      description:
        "I understand that there will be mandatory waiting periods between accessing new content to allow for integration.",
      required: true,
    },
    {
      ...
      description:
        "I consent to receiving prompts that ground spiritual concepts in daily reality and human experience.",
      required: true,
    },
    {
      ...
      description:
        "I am open to community feedback and reality-checking to support authentic development.",
      required: false,
    },
    {
      ...
      description:
        "I consent to receiving professional support referrals when patterns suggest therapeutic benefit.",
      required: false,
    },
  ];
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-600 mb-6">
          Our platform is designed to prevent spiritual bypassing and support
          embodied development. Please review and consent to our approach:
        </p>
            ...
            >
              <label className="flex items-start space-x-3 cursor-pointer">
                <input
                  ...
                  onChange={(e) =>
                    onChange({ [commitment.key]: e.target.checked })
                  }
                  className="mt-1 text-blue-600 focus:ring-blue-500"
                />
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
        ...
        <p className="text-sm text-amber-800">
          This platform supports your development process but cannot replace
          professional mental health care, medical advice, or spiritual
          direction. We encourage maintaining relationships with qualified
...
const CompletionStep: React.FC<{
  ...
  <div className="space-y-6 text-center">
    ...
    <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
      <h4 className="font-medium text-blue-900 mb-2">Ready to Begin?</h4>
      <p className="text-sm text-blue-800 mb-4">
        Your integration-centered development platform is now ready. Take your
        time, honor your process, and remember that sustainable growth happens
