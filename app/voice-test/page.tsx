  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-black to-purple-900 text-white p-8">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        {/* Persona Selector */}
        <div className="bg-purple-800/20 rounded-lg p-6 backdrop-blur">
          ...
          <div className="grid grid-cols-1 gap-2">
            {testPrompts.map((prompt, i) => (
              <button
                ...
                className="text-left px-4 py-2 rounded hover:bg-purple-700/30 transition-colors"
              >
                {i + 1}. {prompt}
              </button>
            ))}
        ...
        {/* Input Area */}
        <div className="bg-purple-800/20 rounded-lg p-6 backdrop-blur space-y-4">
          <textarea
            value={input}
            onChange={(e) => setInput(e.target.value)}
            placeholder="Enter your message for the Oracle..."
            className="w-full p-4 bg-black/50 rounded-lg text-white placeholder-purple-400 h-32 resize-none"
          />
          <button
            onClick={handleSubmit}
            disabled={loading || !input}
            className="px-8 py-3 bg-gradient-to-r from-purple-600 to-pink-600 rounded-lg hover:from-purple-700 hover:to-pink-700 disabled:opacity-50 transition-all"
          >
        ...
        <div className="bg-purple-800/20 rounded-lg p-6 backdrop-blur">
          ...
          <div className="space-y-2 text-center">
            <div className="py-2 bg-purple-700/30 rounded">User Input</div>
            <div className="text-purple-400">↓</div>
            <div className="py-2 bg-purple-700/30 rounded">Maya/Anthony Voice & Presence</div>
            <div className="text-purple-400">↓</div>
            <div className="py-2 bg-purple-700/30 rounded">PersonalOracleAgent Orchestration</div>
            <div className="text-purple-400">↓</div>
            <div className="py-2 bg-purple-700/30 rounded">Claude/OpenAI Intelligence</div>
            <div className="text-purple-400">↓</div>
            <div className="py-2 bg-purple-700/30 rounded">Elemental Wisdom Patterns</div>
            <div className="text-purple-400">↓</div>
            <div className="py-2 bg-purple-700/30 rounded">Fractal Memory Storage</div>
          </div>
        </div>
      </div>
    </div>
