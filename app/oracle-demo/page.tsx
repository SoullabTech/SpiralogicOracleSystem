...
export default function OracleDemoPage() {
  ...
  const generateDemoResponse = (input: string, agent: ElementalAgent): OracleResponse => {
    const responses = {
      fire: {
        ...
        insight: 'Your inner fire calls for bold action. Trust your creative instincts and let passion guide your next steps.',
      ...
      water: {
        ...
        insight: 'Allow your emotions to guide you with wisdom. What feels right in your heart often holds the truest direction.',
      ...
      earth: {
        ...
        insight: 'Build slowly and with intention. Your practical steps today create the stable foundation for tomorrow\'s dreams.',
      ...
      air: {
        ...
        insight: 'Clarity comes through expression. Share your thoughts and let new ideas breathe life into your situation.',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-violet-900 to-purple-900 text-yellow-400">
      ...
      <div className="text-center pt-8 pb-6">
        ...
        <p className="opacity-80">Experience consciousness technology (Demo Mode)</p>
        <Link href="/beta" className="inline-block mt-4 text-yellow-400 hover:text-yellow-300 underline">
      ...
      <div className="container mx-auto px-6 pb-16">
        <div className="max-w-4xl mx-auto">
          {/* Agent Selection */}
          <div className="mb-8">
            <h3 className="text-xl font-semibold mb-4">Choose Your Oracle Agent</h3>
              ...
              <div className="p-6 border-b border-white/10 max-h-60 overflow-y-auto">
                {conversationHistory.map((conversation, index) => (
                  <div key={index} className="mb-6 last:mb-0">
                    ...
                    <div className="bg-white/10 rounded-lg p-3 mb-3 text-sm">{conversation.user}</div>
                    <div className="text-sm opacity-80 mb-2 flex items-center">
                      {agents[conversation.oracle.agent].emoji} {agents[conversation.oracle.agent].name} responded:
                    </div>
            ...
            <form onSubmit={handleSubmit} className="p-6">
              <div className="mb-4">
                <label className="block text-sm font-medium mb-2">
                  Ask the {agents[selectedAgent].name} {agents[selectedAgent].emoji}
                </label>
                <textarea
                  value={userInput}
              ...
              <div className="flex justify-between items-center">
                ...
                >
                  {loading ? 'Channeling...' : `Ask ${agents[selectedAgent].name}`}
                </button>
              </div>
            </form>
          </div>
          ...
          <div className="mt-8 bg-yellow-400/10 border border-yellow-400/30 rounded-lg p-6 text-center">
            <h3 className="text-lg font-semibold mb-2 text-yellow-400">🌟 This is a Demo Experience</h3>
            <p className="opacity-80 mb-4">
              You're experiencing simulated responses. The full platform includes:
            </p>
            ...
            <div className="mt-6">
              <Link href="/beta" className="bg-gradient-to-r from-yellow-400 to-orange-500 text-gray-900 px-6 py-3 rounded-lg font-semibold hover:from-yellow-500 hover:to-orange-600 transition inline-block">
          ...
          <div className="mt-8 bg-white/5 rounded-lg p-6 border border-white/10">
            <h3 className="text-lg font-semibold mb-4">💭 How was your demo experience?</h3>
              ...
              {[1, 2, 3, 4, 5].map((rating) => (
                <button
                  ...
                  onClick={() => {
                    ...
                    alert(`Thank you for rating ${rating}/5! Your feedback helps us improve.`);
                  }}
                >
                  ⭐
                </button>
