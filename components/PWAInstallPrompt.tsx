    ...
    <>
      ...
      {(deferredPrompt || isIOS) && !showInstallPrompt && (
        <motion.button
          ...
          className="fixed top-4 right-4 z-40 bg-purple-600 text-white p-3 rounded-full shadow-lg"
        >
        ...
        {showInstallPrompt && (
          ...
          >
            <motion.div
              ...
              className="bg-gradient-to-br from-purple-950 to-indigo-950 rounded-t-3xl sm:rounded-3xl p-6 max-w-md w-full border border-purple-500/20"
              ...
              {isIOS ? (
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex-1 px-4 py-3 bg-purple-600 hover:bg-purple-700 text-white rounded-xl transition-colors flex items-center justify-center gap-2"
                  >
                    <Download className="w-5 h-5" />
                    Install App
                  </button>
