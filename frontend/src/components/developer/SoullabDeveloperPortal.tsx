...
const SoullabDeveloperPortal: React.FC = () => {
  ...
  const [activeSection, setActiveSection] = useState<'keys' | 'usage' | 'guides'>('keys');
  ...
  if (isLoading) {
    return (
      <div className="soullab-container" style={{ paddingTop: 'var(--space-3xl)', minHeight: '100vh' }}>
        <div className="soullab-fade-in" style={{ textAlign: 'center' }}>
          ...
          <p className="soullab-body" style={{ color: 'var(--text-secondary)' }}>
  ...
  return (
    <div style={{ 
      minHeight: '100vh',
      background: 'linear-gradient(135deg, var(--earth-subtle), var(--air-subtle))',
      ...
      <div className="soullab-container">
        ...
        >
          <h1 className="soullab-heading" style={{
          ...
          <p className="soullab-body" style={{
            fontSize: 'var(--text-lg)',
            color: 'var(--text-secondary)',
            lineHeight: 1.7,
            marginBottom: 'var(--space-xl)'
          }}>
            A sacred space for those who weave technological threads into the fabric of consciousness
          </p>
          ...
          <div style={{
            ...
            <span className="soullab-body" style={{
        ...
        >
          {[
            ...
            <button
              ...
              style={{
                background: activeSection === section.id ? 'var(--earth)' : 'var(--air)',
                ...
                fontWeight: activeSection === section.id ? 'var(--weight-medium)' : 'var(--weight-regular)',
        ...
        <AnimatePresence>
          {error && (
            ...
            >
              <p className="soullab-body" style={{ color: 'var(--fire-dark)', marginBottom: 'var(--space-base)' }}>
                {error}
              </p>
              <button
        ...
        <AnimatePresence mode="wait">
          {activeSection === 'keys' && (
            ...
            >
              ...
              <div className="soullab-card" style={{ marginBottom: 'var(--space-xl)' }}>
                <div style={{
                  display: 'flex',
                  ...
                  <div>
                    <h2 className="soullab-heading" style={{
                    ...
                    <p className="soullab-body" style={{ color: 'var(--text-secondary)' }}>
                      Tools for accessing the collective wisdom of the Oracle network
                    </p>
                  </div>
                  <button
                ...
                <AnimatePresence>
                  {showCreateForm && (
                    ...
                    >
                      <h3 className="soullab-heading" style={{
                      ...
                      <div style={{ marginBottom: 'var(--space-lg)' }}>
                        <label className="soullab-body" style={{
                          display: 'block',
                          marginBottom: 'var(--space-base)',
                          color: 'var(--text-secondary)',
                          fontSize: 'var(--text-sm)'
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-lg)' }}>
                      ...
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
                        <div style={{ flex: 1, marginRight: 'var(--space-lg)' }}>
                          ...
                          <div style={{
                            ...
                            <code className="soullab-mono" style={{
                              fontSize: 'var(--text-sm)',
                              color: 'var(--text-secondary)',
                              flex: 1
                            }}>
                          ...
                          <div style={{
                            ...
                            <span style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-xs)' }}>
                              ...
                              <div style={{
                                ...
                                height: '6px',
                                borderRadius: '50%',
                                background: key.isActive ? 'var(--earth)' : 'var(--text-tertiary)'
                              }}></div>
                            </span>
                          </div>
                        </div>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-lg)' }}>
                          <div style={{ textAlign: 'right' }}>
                            <div className="soullab-body" style={{
                              fontSize: 'var(--text-xs)',
                              color: 'var(--text-tertiary)',
                  ...
                  {apiKeys.length === 0 && (
                    ...
                    >
                      ...
                      <p className="soullab-body" style={{ fontSize: 'var(--text-sm)', marginTop: 'var(--space-sm)' }}>
            ...
            >
              <div className="soullab-card">
                ...
                <div style={{
                  ...
                  {[
                    { label: 'Requests (15min)', value: usageStats.currentPeriodRequests, color: 'earth' },
                    { label: 'Remaining', value: usageStats.rateLimitRemaining, color: 'water' },
                    { label: 'Total Requests', value: usageStats.totalRequests, color: 'fire' },
                    { label: 'Active Keys', value: usageStats.activeKeys, color: 'aether' }
                  ].map((stat, index) => (
                    <motion.div
                      key={stat.label}
                      initial={{ opacity: 0, y: 20 }}
                ...
                <div style={{ marginBottom: 'var(--space-3xl)' }}>
                  <div style={{
                    ...
                    <span className="soullab-body" style={{ fontWeight: 'var(--weight-medium)' }}>
                      Sacred Flow Balance
                    </span>
                    <span className="soullab-body" style={{
                      fontSize: 'var(--text-sm)',
                  ...
                  <div style={{
                    ...
                    <motion.div
                      initial={{ width: 0 }}
                      animate={{ width: `${getUsagePercentage(usageStats.currentPeriodRequests, usageStats.rateLimit)}%` }}
                      transition={{ duration: 1, ease: 'easeOut' }}
                      style={{
                        height: '100%',
                        background: getUsageColorByPercentage(getUsagePercentage(usageStats.currentPeriodRequests, usageStats.rateLimit)),
                        borderRadius: 'var(--radius-base)'
                      }}
                    />
                  </div>
                ...
                <div>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-base)' }}>
                    {usageStats.keyUsage.map((keyUsage, index) => (
                      ...
                      >
                        <div>
                          <div className="soullab-body" style={{ fontWeight: 'var(--weight-medium)' }}>
                            {keyUsage.keyName}
                          </div>
                          {keyUsage.lastUsed && (
                            <div className="soullab-body" style={{
            ...
            >
              <div className="soullab-card" style={{ marginBottom: 'var(--space-xl)' }}>
                ...
                <p className="soullab-body" style={{
                  ...
                  Ancient wisdom for modern integration. Choose your path of technological communion.
                </p>
                ...
                <div style={{
                  ...
                  {Object.entries(quickStartGuides.guides).map(([key, guide], index) => (
                    <motion.div
                      key={key}
                      initial={{ opacity: 0, y: 20 }}
                      animate={{ opacity: 1, y: 0 }}
              ...
              <div className="soullab-card">
                ...
                <div style={{
                  ...
                  {Object.entries(quickStartGuides.resources).map(([key, url], index) => (
                    <motion.a
                      key={key}
                      href={url}
                      target="_blank"
          ...
          >
            ...
            >
              ...
              <p className="soullab-body" style={{
                ...
                Your key has been crafted. Copy it now — this revelation comes but once.
              </p>
          ...
          >
            ...
            >
              ...
              <p className="soullab-body" style={{
                ...
                Are you certain you wish to release "{keyToDelete.name}"? 
                This action dissolves the connection and cannot be undone.
              </p>
