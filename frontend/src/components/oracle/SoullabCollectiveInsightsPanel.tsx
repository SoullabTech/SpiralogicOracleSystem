...
const SoullabCollectiveInsightsPanel: React.FC<SoullabCollectiveInsightsPanelProps> = ({
  className = '',
  ...
  const loadCollectiveInsights = async () => {
    try {
      ...
      setError(err instanceof Error ? err.message : 'Failed to commune with the collective');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  if (!isExpanded) {
    return (
      <motion.div
        ...
        style={{
          background: 'linear-gradient(135deg, var(--earth-subtle), var(--aether-subtle))',
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-lg)' }}>
            ...
            <div style={{ textAlign: 'left' }}>
              ...
              <p className="soullab-body" style={{
                ...
                {insights.length} sacred patterns • {insights.reduce((sum, insight) => sum + insight.relevantUsers, 0)} souls
              </p>
            </div>
          </div>
          ...
          >
              ...
              <div style={{
                ...
                <div style={{ position: 'relative' }}>
                  <select
                    ...
                    onChange={(e) => setSelectedFilters(prev => ({ ...prev, element: e.target.value || undefined }))}
                    className="soullab-input"
                    style={{
                      fontSize: 'var(--text-sm)',
                      padding: 'var(--space-sm) var(--space-base)',
            ...
            {!isLoading && !error && insights.length > 0 && (
              <div style={{
                ...
                {insights.map((insight, index) => {
                  ...
                  const dominantElements = getElementalDominance(insight.elementalResonance);
                      ...
                      <header style={{
                        ...
                        <div style={{ flex: 1 }}>
                          <div style={{
                            ...
                            <h4 className="soullab-heading" style={{
                              fontSize: 'var(--text-lg)',
                              color: 'var(--text-primary)',
                              lineHeight: 1.3
                            }}>
                        ...
                        <div style={{ textAlign: 'right', flexShrink: 0, marginLeft: 'var(--space-base)' }}>
                          ...
                          <div className="soullab-body" style={{
                            ...
                            {Math.round(insight.confidenceLevel * 100)}% resonance
                          </div>
                        </div>
                      </header>
            ...
            {!isLoading && !error && insights.length === 0 && (
              ...
              >
                ...
                <p className="soullab-body">The sacred chamber echoes with silence.</p>
                <p className="soullab-body" style={{
                  fontSize: 'var(--text-sm)',
