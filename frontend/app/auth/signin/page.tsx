...
export default function SignInPage() {
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    if (user) {
      setMessage('Welcome back! Entering sacred space...');
      setTimeout(() => {
        ...
        <div className="bg-soullab-gray-800/80 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-soullab-purple-500/20">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-soullab-gray-300">
              Enter the sacred digital temple
            </p>
          </div>
          ...
          <form onSubmit={handleSignIn} className="space-y-6">
            ...
            >
              {isLoading ? 'Entering Sacred Space...' : 'Sign In'}
            </motion.button>
          </form>
          ...
          <div className="relative my-8">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t border-soullab-gray-600"></div>
            </div>
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-soullab-gray-800/80 text-soullab-gray-400">
                Or continue with
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <motion.button
              ...
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="flex items-center justify-center px-4 py-3 bg-soullab-gray-700/50 border border-soullab-purple-500/30 rounded-lg text-white hover:bg-soullab-gray-700/70 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
            >
          ...
          <div className="mt-8 text-center space-y-2">
            ...
            >
              New to Sacred Technology? Create an account
            </Link>
            <br />
            <Link 
              href="/auth/reset-password" 
              className="text-sm text-soullab-gray-400 hover:text-soullab-gray-300 transition-colors"
            >
