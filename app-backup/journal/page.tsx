      ...
      <div className="min-h-screen  from-slate-900 via-purple-900/20 to-slate-900 flex items-center justify-center">
        <div className="text-center">
          <motion.div
            ...
            className="w-16 h-16  from-green-500 to-blue-500 rounded-full flex items-center justify-center mx-auto mb-4"
          >
        ...
        >
          ...
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              className=" from-green-600 to-blue-500 hover:from-green-700 hover:to-blue-600"
            >
