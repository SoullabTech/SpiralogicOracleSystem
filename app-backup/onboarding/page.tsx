    ...
    return (
      <div className="min-h-screen  from-purple-900 via-violet-900 to-purple-900 text-yellow-400 flex items-center justify-center p-8">
        <div className="text-center max-w-lg">
          <div className="mb-6">
            <div className="w-24 h-24 rounded-full  from-yellow-400 to-orange-500 flex items-center justify-center mx-auto shadow-lg">
          ...
          <div className="space-y-4">
            <Link
              ...
              className=" from-yellow-400 to-orange-500 text-gray-900 px-8 py-4 rounded-lg font-semibold hover:from-yellow-500 hover:to-orange-600 transition inline-block text-lg"
            >
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <div className="w-full bg-white/10 rounded-full h-2">
              <div
                className=" from-yellow-400 to-orange-500 h-2 rounded-full transition-all duration-300"
