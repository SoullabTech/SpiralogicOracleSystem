-- Sacred Beta Users & Oracle Agents Schema - CORE TABLES
-- Migration: 20250909_sacred_beta_users_core
-- Run this FIRST, then run the indexes file
...
-- Success message
SELECT 'Sacred Beta Users Core Tables Created Successfully! 🌟' as result;