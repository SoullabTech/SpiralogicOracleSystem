    ...
    <Layout>
      <div className="max-w-5xl mx-auto w-full space-y-6">
        <div className="text-center">
          ...
          <p className="text-soullab-moon">These dreams all reference the symbol <strong>{symbol}</strong>.</p>
          ...
          {summary && (
            <motion.div
              ...
              className="mt-4 text-sm text-indigo-700 bg-white/60 rounded-xl p-4 border shadow"
            >
              {summary}
            </motion.div>
          )}
